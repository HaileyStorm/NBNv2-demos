...
{
    public XorTaskPlugin(BasicsBinaryTruthTableTaskSettings? settings = null)
        : base(
            taskId: "xor",
            displayName: "XOR",
    ...
    private static IReadOnlyList<BasicsTaskSample> CreateDataset(BasicsBinaryTruthTableTaskSettings settings)
    {
        ...
        [
            ...
            new BasicsTaskSample(InputA: high, InputB: high, ExpectedOutput: 0f, Label: FormatLabel(high, high))
        ];
    }
