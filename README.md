...
- Codex model policy: Sol is the default, Terra and Luna own bounded specialist roles, and Spark is an explicit quota fallback rather than a pinned profile.
